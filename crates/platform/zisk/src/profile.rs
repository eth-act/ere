...
use core::{cell::UnsafeCell, hash::Hasher};

use fnv::FnvHasher;

pub(crate) static SCOPE_REGISTRY: ScopeRegistry = ScopeRegistry::new();
...
impl ScopeRegistry {
    ...
    pub(crate) fn get_or_assign_tag(&self, name: &str) -> u8 {
...
pub(crate) use dispatch_profile;
