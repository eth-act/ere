...
pub enum AirbenderError {
    ...
    AirbenderProveFailed { status: ExitStatus },
    ...
    AirbenderProveFinalFailed { status: ExitStatus },
    ...
    #[error("Unexpected verification key - preprocessed: {preprocessed:?}, proved: {proved:?}")]
    UnexpectedVerificationKey {
        preprocessed: VerificationKey,
        proved: VerificationKey,
    },
}
